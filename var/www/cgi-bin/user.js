...
/**
 * A CGI script (using node) for a simple User API.
 * - GET: Responds to /user.js?id=1 (returns JSON)
 ...
 * @param {string} status The CGI status line (e.g., "200 OK", "404 Not Found")
 * @param {object} body The JavaScript object to send as a JSON response.
 */
...
/**
 * Handles GET requests (e.g., /user.js?id=1)
 */
