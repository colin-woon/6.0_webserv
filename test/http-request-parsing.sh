...
# echo "TEST 16.4: grammar error - HTTP"
# echo "EXPECTED: 400 Bad Request, Connection: closed"
# echo "----------------------------------------"
# send_request "GET / HPPT/1.2\r\nHost: localhost\r\n\r\n"
# echo ""

# echo "TEST 16.5: grammar error - HTTP version"
# echo "EXPECTED: 400 Bad Request, Connection: closed"
# echo "----------------------------------------"
...
# echo "TEST 17: method longer than 10 octets."
# echo "EXPECTED: 501 Not Implemented status code"
# echo "----------------------------------------"
...
# echo "TEST 18: request-target longer than 8000 octets."
# echo "EXPECTED: 414 URI Too Long status code"
# echo "----------------------------------------"
# long_uri=$(printf '/%.0s' $(seq 1 7985))
# send_request "GET $long_uri HTTP/1.1\r\nHost: localhost\r\n\r\n"
# echo ""

# echo "TEST 20: Request target with multiple whitespace."
# echo "EXPECTED: 400 Bad Request"
# echo "----------------------------------------"
# send_request "GET /path   with   multiple   spaces HTTP/1.1\r\nHost: localhost\r\n\r\n"
# echo ""

# echo "TEST 21.0: Request with missing Host header"
# echo "EXPECTED: 400 Bad Request"
# echo "----------------------------------------"
# send_request "GET / HTTP/1.1\r\n\r\n"
# echo ""

# echo "TEST 21.1: Request with multiple Host headers."
# echo "EXPECTED: 400 Bad Request"
# echo "----------------------------------------"
# send_request "GET / HTTP/1.1\r\n\r\nHost: localhost\r\nHost: localhost\r\n\r\n"
# echo ""

# echo "TEST 22: Empty request target."
# echo "EXPECTED: Redirect to default / (root) directory"
# echo "----------------------------------------"
# send_request "GET  HTTP/1.1\r\nHost: localhost\r\n\r\n"
# echo ""
